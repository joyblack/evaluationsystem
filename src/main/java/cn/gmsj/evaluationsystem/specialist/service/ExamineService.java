...
import cn.gmsj.evaluationsystem.specialist.domain.repository.ExamineRepository;
import cn.gmsj.evaluationsystem.specialist.web.req.ExamineReq;
import cn.gmsj.evaluationsystem.exception.WafException;
import cn.gmsj.evaluationsystem.government.domain.entity.ProjectInviteEntity;
import cn.gmsj.evaluationsystem.government.domain.repository.ProjectInviteRepository;
import cn.gmsj.evaluationsystem.specialist.web.req.ExpertInfoReq;
...
public class ExamineService {
    ...
    public JSONObject getAll(ExpertInfoReq.ExamineListReq examineListReq, HttpServletRequest request) {
