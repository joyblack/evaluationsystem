...
import cn.gmsj.evaluationsystem.specialist.service.ExamineService;
...
public class ExamineController {
    ...
    @PostMapping(
            value = "/getAll",
            produces = {"application/json;charset=UTF-8"})
    public Object getAll(@RequestBody ExpertInfoReq.ExamineListReq examineListReq, HttpServletRequest request) {
