package cn.gmsj.evaluationsystem.userreg.service.verify;
...
public class MessageCode {
	...
	// 根据相应的手机号发送验证码
		...
		//	String sig = MD5Util.encode(ACCOUNT_SID, AUTH_TOKEN, timestamp);
			String tamp = "【煤矿设计院】您的验证码为：" + rod + "，您正在使用短信验证注册功能，该验证码仅用于身份验证，请勿泄露给他人使用。";
			...
			try {
				...
				String args = getQueryArgs(ACCOUNT_SID, tamp, phone, timestamp,  "JSON");
				out.write(args);
				out.flush();
				// 读取返回参数
